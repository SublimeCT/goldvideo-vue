(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["GoldVideo"] = factory(require("vue"));
	else
		root["GoldVideo"] = factory(root["Vue"]);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "H265Player", function() { return /* reexport */ src_H265Player; });
...
// CONCATENATED MODULE: ./src/components/H265Player/src/H265Player.tsx
...
var H265Player_H265Player = /*#__PURE__*/function (_Vue) {
  _inherits(H265Player, _Vue);

  var _super = _createSuper(H265Player);

  function H265Player() {
    _classCallCheck(this, H265Player);

    return _super.apply(this, arguments);
  }

  _createClass(H265Player, [{
    key: "onUpdateSourceURL",
    value: function onUpdateSourceURL() {
      this.onDestroy();
      this.init();
    }
  }, {
    ...
    value: function render() {
      var h = arguments[0];
      return h("div", {
        "class": "goldvideo-h265-player-component"
      }, [h("div", {
        "ref": "player",
        "style": this._sheets,
        "class": "h265-palyer"
    ...
    value: function init() {
      ...
      this.player.events.on('LoadData.onFirstLoaded', function (evt) {
        if (_this.debug) console.log('[H265Player component] LoadData.onFirstLoaded', evt);

        _this.$emit('firstLoaded', evt);
      });
    }
  }, {
    key: "onDestroy",
...
__decorate([Prop({
  default: false
})], H265Player_H265Player.prototype, "debug", void 0);

__decorate([Prop()], H265Player_H265Player.prototype, "width", void 0);

__decorate([Prop()], H265Player_H265Player.prototype, "height", void 0);

__decorate([Prop()], H265Player_H265Player.prototype, "sheets", void 0);

__decorate([Prop({
  required: true
})], H265Player_H265Player.prototype, "options", void 0);

__decorate([Watch('options.sourceURL')], H265Player_H265Player.prototype, "onUpdateSourceURL", null);

H265Player_H265Player = __decorate([vue_class_component_esm({
  name: 'h265-player'
})], H265Player_H265Player);
/* harmony default export */ var src_H265Player = (H265Player_H265Player);
